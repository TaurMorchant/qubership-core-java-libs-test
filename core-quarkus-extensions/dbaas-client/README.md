...
| quarkus.dbaas.datasources.\<logicalDbName\>.initial-sql                                 | SQL statement executed on every new connection for the datasource with the specified logical DB. Falls back to `quarkus.dbaas.datasource.initial-sql` if not set or set empty.                                                                                                                                  | `none. Optional`                                        | since 10.0.2 |
